...
**Reference implementation:** debank-mcp — GitHub [`IQOfficial/mcp-debank`](https://github.com/IQOfficial/mcp-debank) (npm `@iqai/mcp-debank`). Read the named files there when a task says "copy/adapt from debank"; on the dev machine it sits as a sibling directory of this repo.
